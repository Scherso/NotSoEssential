...
public class EssentialConfigTransformer implements ITransformer
{
    ...
    /**
     * Attempting to transform the EssentialConfig class. Any configuration options local to this class will be
     * transformed according to their 'usefulness', or lack thereof. <br>
