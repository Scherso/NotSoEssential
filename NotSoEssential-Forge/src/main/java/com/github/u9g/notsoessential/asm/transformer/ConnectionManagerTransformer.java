...
public class ConnectionManagerTransformer implements ITransformer
{
     ...
     * {@link com.github.u9g.notsoessential.asm.transformer.OnboardingDataTransformer} already attempts to deny the
    ...
    public void transform(ClassNode classNode, String name)
    {
        for (MethodNode method : classNode.methods)
        {
             ...
             * are not cleared, as clearing constructor methods
             * would cause a crash. */
            ...
            if (method.desc.endsWith("Z"))
            {
                ...
                this.clearInstructions(method);
                method.instructions.insert(this.createInsnList(new InsnNode(ICONST_0), new InsnNode(IRETURN)));
            }
        }
    }
